...
public:
    ...
    void LoadSceneFromFilePhotonMap(QFile &file, const QStringRef &local_path, Scene &scene, PhotonMapIntegrator &integrator);
    ...
    PhotonMapIntegrator LoadPhotonMapIntegrator(QXmlStreamReader &xml_reader);
